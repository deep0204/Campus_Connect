...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-r from-[#0EA5E9] to-[#9b87f5] py-7 md:py-7 relative overflow-hidden">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2 mt- md:mt-0 z-10 flex justify-center items-center">
  <img 
    src="/LandingLogo.png" 
    alt="CampusConnect Graphic" 
    className="w-[380px] md:w-[450px] lg:w-[500px] h-auto object-contain"
  />
</div>
